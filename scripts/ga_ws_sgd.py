...
json_file_path = os.path.join('results', "esgd_ws.json")
convergence_speed_plot = os.path.join('figures', "esgd__ws_convergence_speed.png")
stability_plot = os.path.join('figures', "esgd__ws_stability.png")
accuracy_plot = os.path.join('figures', "esgd__ws_accuracy.png")
